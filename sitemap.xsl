	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
			<head>
				...
				<xsl:variable name="tableMinWidth" select="'727'"/><xsl:variable name="colorMain" select="'#222222'"/><xsl:variable name="colorAccent" select="'#00a0d2'"/><xsl:variable name="relativeFontColor" select="'#ffffff'"/><title>XML Sitemap - Judah Owens</title>
...
<link rel="icon" href="/wp-content/uploads/2026/03/favicon-j-1.png" sizes="32x32" />
<link rel="icon" href="/wp-content/uploads/2026/03/favicon-j-1.png" sizes="192x192" />
<link rel="apple-touch-icon" href="/wp-content/uploads/2026/03/favicon-j-1.png" />
<meta name="msapplication-TileImage" content="/wp-content/uploads/2026/03/favicon-j-1.png" />
			</head>
			<body class="ltr">
				<div id="description">
					<div class="wrap">
						<a href="/"><h1><img src="/wp-content/uploads/2026/03/J-logo-white-150x150.png" width="29" height="29" />Judah Owens — XML Sitemap</h1></a>
<p>
